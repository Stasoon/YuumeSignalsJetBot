...
from src.database.users import get_locale
...
class ACLMiddleware(I18nMiddleware):
    ...
    def set_locale(self, new_lang_code: str):
        if new_lang_code in self.available_locales:
            self.ctx_locale.set(new_lang_code)
